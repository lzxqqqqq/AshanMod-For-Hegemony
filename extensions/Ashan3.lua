...
--[[
*【血握】锁定技，当你受到一次伤害时，防止此伤害并获得1枚“血”标记。锁定技，出牌阶段，当你对距离2内一名其他角色造成一次伤害后，你移除1枚“血”标记。锁定技，出牌阶段结束时时，你失去X点体力并移除所有“血”标记（X为你拥有的“血”标记数目）。
...
sgs.LoadTranslationTable{
	...
	["#xuewo"] = "%from 抑制住伤势！",
	["@xue"] = "血",
	[":Mxuewo"] = "锁定技，当你受到一次伤害时，防止此伤害并获得1枚“血”标记。锁定技，出牌阶段，当你对距离2内一名其他角色造成一次伤害后，你移除1枚“血”标记。锁定技，出牌阶段结束时时，你失去X点体力并移除所有“血”标记（X为你拥有的“血”标记数目）。",
	["Mshikong"] = "时空",
	["$Mshikong1"] = "休养生息，伺机再战！",
	["$Mshikong2"] = "哈……摄点血！",
...
*【暴行】锁定技，你根据X的大小你获得以下效果（X为已损失体力）：
	【X>0】你的普通【杀】均视为【火杀】。
	【X>1】当你使用【杀】指定目标后，你弃置其一张牌:此【杀】被【闪】抵消后，其摸一张牌，然后你将一张手牌置于牌堆顶。
	【X>2】当你受到一次其他角色造成的伤害后，你摸一张牌并视为对伤害来源使用了一张【火杀】：若该【火杀】造成伤害，其无法使用基本牌直到其回合结束。
...
Mbaoxing = sgs.CreateTriggerSkill{
	...
	on_cost = function(self, event, room, target, data, player)
		...
		elseif event == sgs.Damaged then
			if player:hasShownSkill(self) or player:askForSkillInvoke("Mbaoxing2", data) then
				room:notifySkillInvoked(player, self:objectName())
				return true
			end
		end
...
sgs.LoadTranslationTable{
	...
	[":Mbaoxing"] = "锁定技，你根据X的大小你获得以下效果（X为已损失体力）：\n【X>0】\n你的普通【杀】均视为【火杀】。\n【X>1】\n当你使用【杀】指定目标后，你弃置其一张牌:此【杀】被【闪】抵消后，其摸一张牌，然后你将一张手牌置于牌堆顶。\n【X>2】\n当你受到一次其他角色造成的伤害后，你摸一张牌并视为对伤害来源使用了一张【火杀】：若该【火杀】造成伤害，其无法使用基本牌直到其回合结束。",
	["Mchongzhuang"] = "冲撞",
